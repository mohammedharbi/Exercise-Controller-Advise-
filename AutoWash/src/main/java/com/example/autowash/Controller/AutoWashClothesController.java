...
public class AutoWashClothesController {
    ...
    @PostMapping("/add")
    public ResponseEntity addAutoWashClothes(@RequestBody @Valid AutoWashClothes autoWashClothes) {
    ...
    public ResponseEntity updateAutoWashClothes(@PathVariable Integer id, @RequestBody @Valid AutoWashClothes autoWashClothes) {
