...
public class WashingMachineClothesController {
    ...
    @PostMapping("/add")
    public ResponseEntity addWashingMachineClothes(@RequestBody @Valid WashingMachineClothes washingMachineClothes){
    ...
    public ResponseEntity updateWashingMachineClothes(@PathVariable Integer id,@RequestBody @Valid WashingMachineClothes washingMachineClothes){
