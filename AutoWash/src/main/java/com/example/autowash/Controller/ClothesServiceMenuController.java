...
public class ClothesServiceMenuController {
    ...
    @PostMapping("/add")
    public ResponseEntity addClothesServiceMenu(@RequestBody @Valid ClothesServiceMenu clothesService){
    ...
    public ResponseEntity updateClothesServiceMenu(@PathVariable Integer id, @RequestBody @Valid ClothesServiceMenu clothesServiceMenu){
