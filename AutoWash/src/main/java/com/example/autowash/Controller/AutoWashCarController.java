...
public class AutoWashCarController {
    ...
    @PostMapping("/add")
    public ResponseEntity addAutoWashCar(@RequestBody @Valid AutoWashCar autoWashCar) {
    ...
    public ResponseEntity updateAutoWashCar(@PathVariable Integer id, @RequestBody @Valid AutoWashCar autoWashCar) {
