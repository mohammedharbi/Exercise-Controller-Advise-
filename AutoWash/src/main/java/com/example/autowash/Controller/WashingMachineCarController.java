...
public class WashingMachineCarController {
    ...
    @PostMapping("/add")
    public ResponseEntity addWashingMachineCar(@RequestBody @Valid WashingMachineCar washingMachineCar) {
    ...
    public ResponseEntity updateWashingMachineCar(@PathVariable Integer id,@RequestBody @Valid WashingMachineCar washingMachineCar) {
