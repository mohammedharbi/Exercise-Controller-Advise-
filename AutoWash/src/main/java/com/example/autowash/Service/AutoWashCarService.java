...
public class AutoWashCarService {
    ...
    public List<AutoWashCar> nearAutoWashCar(Integer userId, String keyword) {
        ...
        List<AutoWashCar> nearAutoWashCars = autoWashCarRepository.getAutoWashCarsByLocationContainingIgnoreCase(keyword);
        if (nearAutoWashCars.isEmpty()) {throw new ApiException("cannot find any near auto wash cars matching keyword:" + keyword);}
        return nearAutoWashCars;
    }
    ...
    public List<AutoWashCar> openAutoWashCar(Integer userId) {
        ...
        List<AutoWashCar> openAutoWashCars = autoWashCarRepository.getAutoWashCarsByStatus();
        if (openAutoWashCars.isEmpty()){throw new ApiException("cannot find any open AutoWashCars");}
        return openAutoWashCars;
    }
