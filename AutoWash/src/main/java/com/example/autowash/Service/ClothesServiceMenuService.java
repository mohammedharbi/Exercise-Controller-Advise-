...
public class ClothesServiceMenuService {
    ...
    public List<ClothesServiceMenu> getServiceByAutoWashClothes(Integer autoWashClothesId){
        List<ClothesServiceMenu> getServiceByAutoWashClothes = clothesServiceMenuRepository.getClothesServiceMenuByAutoWashClothesId(autoWashClothesId);
        if (getServiceByAutoWashClothes.isEmpty()){throw new ApiException("No services found for the auto wash clothes");}
        return getServiceByAutoWashClothes;
    }
    ...
    public ClothesServiceMenu getCheapestPrice(Integer userId) {
        ...
        if (tempClothesServiceMenu == null){throw new ApiException("no service found to compare for the cheapest price");}
